/**
 * Worker Personal Statistics API
 * Returns stats for the logged-in worker
 * - Reviews created by them
 * - Reviews updated/completed by them
...
export async function GET() {
    try {
        ...
        // This endpoint is for workers, but admins can also access it
