...
const INDUSTRIES = [
    ...
    { name: "Pltrier", slug: "PLASTERER", data: PLASTERER },
    { name: "Maon", slug: "MASONRY_CONTRACTOR", data: MASONRY },
    { name: "Serrurier", slug: "LOCKSMITH", data: LOCKSMITH },
    { name: "Isolation", slug: "INSULATION_CONTRACTOR", data: INSULATION },
    { name: "LED Intrieur", slug: "LED_LIGHT_INSTALL", data: LED_LIGHT },
...
async function main() {
    ...
    // Ensure admin exists
    if (!admin) {
        console.log(" Admin not found, checking for any admin...");
    ...
    for (const industry of INDUSTRIES) {
        ...
        await prisma.category.upsert({
            ...
            create: {
                ...
                name: industry.name,
                slug: industry.slug,
                description: `Catgorie principale pour ${industry.name}`,
                isActive: true
            }
        });
